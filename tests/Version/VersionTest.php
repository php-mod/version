...
class VersionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function successfulParsedVersions()
    {
        return array(
            ...
            'date as path' => array('2.5.0-2011-12-20', '2.5.0-2011-12-20'),
            'date as path 2' => array('2.5.0-2011-12-21-2', '2.5.0-2011-12-21-2'),
     ...
     * @param $version2
     */
    public function testCompare($expected, $version1, $version2)
    {
        $this->assertSame($expected, Version::parse($version1)->compare(Version::parse($version2)));
    }
    ...
    public function compareProvider()
    {
        return array(
            ...
            array(-1, '1.0.0', '1.0.0-2019-10-10'),
            array(-1, '1.0.0', '1.0.0-2019-10-10'),
            array(-1, '1.0.0', '1.0.0-2019-10-10-2'),
            array(0, '1.0.0-2019-10-10', '1.0.0-2019-10-10'),
            array(-1, '1.0.0-2019-10-10', '1.0.0-2019-10-11'),
            array(1, '1.0.0-2019-10-12', '1.0.0-2019-10-11'),
            array(0, '1.0.0-2019-10-10-2', '1.0.0-2019-10-10-2'),
            array(-1, '1.0.0-2019-10-10-2', '1.0.0-2019-10-10-3'),
            array(1, '1.0.0-2019-10-10-3', '1.0.0-2019-10-10-2'),
            array(-1, '1.0.0-2019-10-10', '1.0.0-2019-10-10-2'),
            array(-1, '1.0.0-2019-10-10', '1.0.0-2019-10-10-2'),
        );
    }
}
